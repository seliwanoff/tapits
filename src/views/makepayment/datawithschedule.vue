...
export default {
    ...
    methods: {
     ...
     async  handleSubmit(){
           ...
           const datas  = JSON.parse(localStorage.getItem('user'));
            ...
            try{
                 const response =  await  axios.post(`${process.env.VUE_APP_BASE_URL}api/sme`,data,{
                headers: {
          ...
          this.token = datas.data.token
           const datass = {
                ...
                try{
                const response = await axios.post(`${process.env.VUE_APP_BASE_URL}api/scheadule`,datass,{
                  headers:{
                    Authorization: "Bearer "+ this.token
                  }
                })
    ...
    async mounted(){
        const billdata  = JSON.parse(localStorage.getItem('sub'));
            ...
            this.end = billdata.end,
            this.start = billdata.start,
            this.fr = billdata.fr
            this.networkname = billdata.networkname
