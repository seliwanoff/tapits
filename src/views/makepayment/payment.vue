<template>
  <div>
    ...
    <div class="rg-c">
      <div class="gc-x">
        <h2 class="hc-x" style="text-align: center">
          &#8358;{{ Intl.NumberFormat().format(redam) }}
        </h2>
            ...
            <div class="ml-xf">
              <div class="lcl-xj">
                <div class="acc-de">
                  <div class="each-de">
                    <p>Meter Name</p>
                    <p style="font-size: 0.8rem !important">{{ metername }}</p>
                  </div>
                  <div class="each-de">
                    <p>Amount</p>
                  ...
                  <div class="each-de">
                    <p>Meter Number</p>
                    <p style="font-size: 0.8rem !important">{{ billersCode }}</p>
                  </div>
                  <div class="each-de">
                    <p>Service</p>
                    <p style="font-size: 0.8rem !important">{{ service }}</p>
                  </div>
                  <div class="each-de">
                    <p>Meter Type</p>
                    <p style="font-size: 0.8rem !important">{{ variation_code }}</p>
                  </div>
                  <div class="each-de">
