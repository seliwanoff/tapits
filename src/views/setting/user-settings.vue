        ...
        <div class="rg-c">
            ...
            <div class="gc-x">
             <div class="tab-banner">
                <TabNav :tabs="['Personal','Upgrade','Manage']" :selected="selected" @selected="setSelected">
                    ...
                    <form @submit.prevent="handleSubmit">
                        ...
                        <div>
                            <router-link to="/setting/edit-profile">
                              <button style="max-width:200px;margin-top:20px;cursor:pointer">Edit</button>
                            </router-link>
                        </div>
                        </form>
                    </main>
               ...
               <Message :status="status" :message="message"/>
                ...
                <Message :status="status" :message="message"/>
                   ...
                   <!--<div class="ml-xf">
                    ...
                    --> 
                     <div class="ml-xf">
                      <strong>Note:</strong> <span style="font-size:.9rem">
                      Before you are eligible to upgrade your accountto merchant. You have to have atleast &#8358;10,000 in your wallet
                  ...
                  <form @submit.prevent="handlePassword">
                    ...
                    <div class="ml-xf">
                        <label for="email">Password</label> <br>
                         <input type="password" placeholder="Enter your password" v-model="dpassword" required autocomplete="">
                    </div>
                    
                     <div class="ml-xf">
                        <label for="number">New Password</label>
                         <input type="password" placeholder="Select your date of Birth" v-model="npassword" required autocomplete="">
                    </div>
                     <div class="ml-xf">
                        <label for="number">Confirm New Password</label>
                         <input type="password" placeholder="Confirm Your New password" v-model="cnpassword" required autocomplete="">
                    </div>
                    <div class="ml-xf" >
                      <button :disabled="isDisabled" style="margin-top:10px !important" >{{btnPass}}</button>
                    </div>
           ...
           try{
            ...
            'Content-Type':'application/json',
              'Authorization': 'Bearer '+this.token
                    ...
                    const response = await axios.post(`${process.env.VUE_APP_BASE_URL}api/updatemerachant`,{
                      headers:headers
                    })
      ...
      this.btnPass='Loading'
          if(this.npassword.length >= 6){
              if(this.npassword == this.cnpassword){
                ...
                try{
                    const response = await axios.post(`${process.env.VUE_APP_BASE_URL}api/updatepassword`,data,{
                      headers:{
                          Authorization: 'Bearer '+this.token
                      }
                    })
