              ...
              <h2 class="hc-x">Edit Profile</h2>
                ...
                <form @submit.prevent="handleSubmit" enctype="multipart/form-data">
                     ...
                     <div v-else class="nhi">
                       ...
                       <input type="file" style="display:none"  ref="fileInput" @change="onSelectedFile">
                    </div>
                    <div class="ml-xf">
...
export default {
    ...
    data() {
      return {
        ...
        imageUrl:'',
        image:null,
        storage:'https://tap.150psi.com/public/storage/images/',
      ...
      async handleSubmit(){
       ...
       // const ext = filename.slice(filename.lastIndexOf('.'))
        ...
        formdata.append('lname',this.lname)
            ...
            this.token = datas.data.token
            try{
              const response = await axios.post(`${process.env.VUE_APP_BASE_URL}api/updateuser`,formdata,{
                headers:{
                  Authorization:"Bearer "+this.token,
          ...
          try{
              ...
              const response = await axios.post(`${process.env.VUE_APP_BASE_URL}api/updateuser`,data,{
                headers:{
                  Authorization:"Bearer "+this.token
                }
              })
