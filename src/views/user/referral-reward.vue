              ...
              <div v-if="length > 0">
                <div class="info-rfer-user" v-for="item in refferds" :key="item.id">
                  <div class="info-pix-name">
                    ...
                    <br />
                    <span
                      style="font-size: 0.8rem; margin-left: 30px; display: inherit"
                      >{{ moment(item.updated_at).format("DD-MM-YYYY") }}</span
                    >
                  </div>
                  <span class="nhy-ck" style="display: inline-block; margin-top: 10px"
                    >&#8358;{{ item.er }}</span
                  >
                </div>
              </div>
