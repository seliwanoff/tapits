                ...
                <div class="ml-xf">
                       <div class="lcl-xj" >
                        <div class="acc-de">
                            ...
                            <div class="each-de" v-if="name!=null && network==user && type==4">
                                <p  class="bfn">Receiver Name</p>
                               <p>{{name}}</p>
                            </div>
                            <div class="each-de" v-else-if="name!=null && network==user && type!=4">
                                <p  class="bfn">Receiver Name</p>
                               <p>{{name}}</p>
                            </div>
                            
                            <div class="each-de" v-else-if="type==1 || type==2">
