                ...
                <form @submit.prevent="handleSubmit">
                    ...
                    <div class="ml-xf">
                        <label for="email">Phone Number</label> <br>
                         <input type="number" placeholder="08132112841" v-model="phone" required @keyup="getUser" @keypress="checkAll">
                    </div>
                     <div class="ml-xf">
...
export default {
    ...
    methods: {
          ...
          /* try{
               const transfer = await axios.post(`${process.env.VUE_APP_BASE_URL}api/transaction`,data,{
                headers:{
               ...
               this.status= true,
               this.message = transfer.data.message,
          ...
          async getUser(){
            ...
            try{
              const resp = await axios.get(`${process.env.VUE_APP_BASE_URL}api/getuser?phone=${'234'+this.phone}`,{
                headers:{
