<template>
    <div>
        ...
        <div class="rg-c">
            <div class="gc-x">
              <h2 class="hc-x">Select Airtime Preference</h2>
                <main>
                    ...
                    <div class="ml-xf">
                       <div class="lcl-xj">
                           <div class="icox-col">
                            ...
                            <div class="each-pre">
                                <h4>Single recharge</h4>
                                <span>Recharge for one user at a time</span>
                            </div>
                       </div>
                    </div>
                     </router-link>
                    <router-link to="/service/multiple-airtime">
                     <div class="ml-xf">
                       ...
                       <div class="icox-col">
                         <span class="fa fa-users icox"></span>
                          ...
                          <div class="each-pre">
                                <h4>Multipe recharge</h4>
                                <span>Recharge for multiple at a time</span>
                            </div>
                       </div>
                    </div>
                    </router-link>
