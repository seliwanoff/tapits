                    ...
                    <div class="ml-xf">
                     ...
                     <div class="ml-xf">
                        <label for="number">Password</label>
                         ...
                         <span class="forget">
                          <router-link to="/forget/reset" style="color:#0A1AA8;font-size:700">Forget Password?</router-link>
                         </span>
                    </div>
                    <div class="ml-xf" >
...
export default {
    ...
    methods: {
        ...
        async handleSubmit(){
            ...
            try{
                const response = await axios.post(`${process.env.VUE_APP_BASE_URL}api/auth/login`,data);
